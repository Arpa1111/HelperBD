...
<?php
	...
	if($email == "" || $fname == "" || $lname == "" || $phone == "" || $password == "" || $city == "" || $bcn == "" || $nidn == "" || $psp == "" || $nidc == "" || $bc == ""|| $cost == ""){
		...
		echo '<script type="text/javascript">Swal.fire({
			...
			$reg="insert into employee(email,fname,lname,phone,password,city,bcn,nidn,psp,nidc,bc,cost) values('$email','$fname','$lname','$phone','$password','$city','$bcn','$nidn','$psp','$nidc','$bc','$cost')";
